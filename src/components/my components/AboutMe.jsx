...
const AboutMe = () => {
  return (
    <section id="about" className="font-main py-16 px-4 bg-white dark:bg-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold">
          About Me
        </h1>
        <p className="text-gray-700 dark:text-gray-300 mt-6 text-lg md:text-xl leading-relaxed">
          Hi, I’m <span className="font-semibold text-blue-600 dark:text-blue-400 font-mono">Mahir Mohammed Labib</span>! 👋 <br />
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-6 text-lg md:text-xl leading-relaxed">
          Off the screen, I'm a huge <span className="text-purple-500 font-semibold">cricket lover</span> 🏏—whether it’s 
